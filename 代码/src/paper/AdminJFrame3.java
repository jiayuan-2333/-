...
public class AdminJFrame3 extends JFrame{
	...
	public AdminJFrame3() {
	     ...
	     JButton jb = new JButton("查看所有老师信息");
	     jb.setBounds(65, 20, 140, 30);
	     cp.add(jb);
	     
	     JButton jb2 = new JButton("查看某个老师信息");
	     jb2.setBounds(65, 60, 140, 30);
	     cp.add(jb2);
	     
	     JButton jb3 = new JButton("增加某个老师信息");
	     jb3.setBounds(220, 20, 140, 30);
	     cp.add(jb3);
	     
	     JButton jb4 = new JButton("删除某个老师信息");
	     jb4.setBounds(220, 60, 140, 30);
	     cp.add(jb4);
	     
	     JButton jb5 = new JButton("更新某个老师信息");
